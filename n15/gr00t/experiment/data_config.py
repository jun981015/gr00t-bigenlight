...
from gr00t.data.transform.concat import ConcatTransform, RLConcatTransform, RLStateConcatTransform
...
from gr00t.model.transforms import GR00TRLStateTransform, GR00TRLTransform, GR00TTransform
...
class SinglePandaGripperRLDataConfig(BaseDataConfig):
    video_keys = [
        "video.left_view",
        "video.right_view",
        "video.wrist_view",
...
class SinglePandaGripperRLInferenceConfig(BaseDataConfig):
    video_keys = [
        "video.left_view",
        "video.right_view",
        "video.wrist_view",
...
class SinglePandaGripperRLStateDataConfig(BaseDataConfig):
    state_keys = [
        "state.end_effector_position_relative",
        "state.end_effector_rotation_relative",
        "state.gripper_qpos",
...
class SinglePandaGripperRLHalfDataConfig(BaseDataConfig):
    video_keys = [
        "video.left_view",
        "video.right_view",
        "video.wrist_view",
...
class DroidPandaWristGripperDataConfig(BaseDataConfig):
    video_keys = [
        "video.front_view",
        "video.wrist_view",
    ]
