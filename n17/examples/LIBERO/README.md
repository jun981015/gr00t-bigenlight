...
이 서버의 RAID 저장소와 분리된 실행 환경은 [local setup](local/README.md)을 참고하세요.
공개 demo만 사용하는 BC 준비와 DEAS actor/critic 구조 분석은 [finetune recipe](finetune/README.md)를 참고하세요.
