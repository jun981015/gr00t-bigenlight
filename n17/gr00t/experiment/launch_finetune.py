...
if __name__ == "__main__":
    ...
    config.training.resume_checkpoint_path = ft_config.resume_checkpoint_path
    config.training.keep_latest_training_state = ft_config.keep_latest_training_state
    config.training.max_run_seconds = ft_config.max_run_seconds
    config.training.first_save_step = ft_config.first_save_step
    config.training.save_interval_seconds = ft_config.save_interval_seconds
    config.training.save_at_steps = ft_config.save_at_steps
